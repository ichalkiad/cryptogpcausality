...
% test1_optim_predmlin_Matern_XRP_Ttot_FnG_ret_meancov_lag1_XRP2_len91_from1_to91_time787542.mat
    ...
    for lag_ii = 1:length(lag_set)
        ...
        for ifret_ii = 1:length(ifret_set)
            ...
            for cm_ii = 1:length(cm_set)
                ...
                if cm_ii-1
                    name_cause  = 'mean';
                    name = [name_p1,'_',name_p2,'_FnG_',name_data,'_',name_cause, '_lag',num2str(lag),'_meanchi'];
                else
                    name_cause  = 'meancov';
                    name = [name_p1,'_',name_p2,'_FnG_',name_data,'_',name_cause, '_lag',num2str(lag)];
                end
...
% save('Lois49_GPC_fin_n_NLP_FnG_plotter_from_L21_34_47')
...
load('Lois49_GPC_fin_n_NLP_FnG_plotter_from_L21_34_47')
...
print_window_dates = window_dates([1,30,60,length(window_dates)]);
...
for ii = 1:3
    ...
    xlim([1 92])
    ylim([0 1])
    title(['chiXY ', name_p1_which, ' ', name_p2_which,'FnG lag ', num2str(lag)])
    ...
    xlim([1 92])
    ylim([0 1])
    title(['chiYX ', name_p1_which, ' ', name_p2_which,'FnG  lag ', num2str(lag)])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% date for flipping it around in excel:
for_excel_data_fin_NLP_FnG = [params_used;temp_chiYX];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
