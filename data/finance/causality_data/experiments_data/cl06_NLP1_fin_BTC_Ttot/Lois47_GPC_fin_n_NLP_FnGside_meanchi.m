...
function [C_XY, C_YX, chi2_XY, chi2_YX, hyperparameters] ...
                 = ...
         Lois47_GPC_fin_n_NLP_FnGside_meanchi(lag, pairs, if_returns, ...
...
load('Lois31_NLP_financial_data_aligned_lag');
...
name = [name_p1,'_',name_p2,'_FnG_',name_data,'_',name_cause, '_lag',num2str(lag),'_meanchi']
        for t_i = 1:dates_points_nr
            ...
            data(:,3)    = zscore(data_used_fin(dates_start:dates_end,5));
            Data_cuts(:,:,t_i) = data;
        end
...
[C_XY, C_YX, chi2_XY, chi2_YX, hyperparameters] ...
                   = ...        
test1_optim_data1_like_structure_side_corrected...
                            (Data_cuts,1, to_loop,...
