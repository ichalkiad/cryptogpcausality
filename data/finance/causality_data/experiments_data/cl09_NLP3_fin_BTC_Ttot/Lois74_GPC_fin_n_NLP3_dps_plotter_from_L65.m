...
labels_cryptodata = ['BTC'];
labels_NLP = ['T';'C'];

repeating_name_part =  'test1_optim_predmlin_Matern_';
% test1_optim_predmlin_Matern_BTC_C_prc_meancov_lag7_SENTIMENT3_dps_len91_from1_to92_time548353.mat
        ...
        for ifret_ii = 1:length(ifret_set)
            ...
            for cm_ii = 1:length(cm_set)
                ...
                if cm_ii-1
                    ...
                    name_cause  = 'meancov';
                    name = [name_p1,'_',name_p2,'_',name_data,'_',name_cause, ...
                            '_lag',num2str(lag),'_SENTIMENT3_dps'];
...
save('Lois74_GPC_fin_n_NLP3_dps_plotter_from_L65')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load('Lois74_GPC_fin_n_NLP3_dps_plotter_from_L65')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ii = 1:3
    ...
    xlim([1 92])
    ylim([0 1])
    title(['chiXY ', name_p1_which, ' ', name_p2_which,' lag ', num2str(lag)])
    ...
    xlim([1 92])
    ylim([0 1])
    title(['chiYX ', name_p1_which, ' ', name_p2_which,' lag ', num2str(lag)])
