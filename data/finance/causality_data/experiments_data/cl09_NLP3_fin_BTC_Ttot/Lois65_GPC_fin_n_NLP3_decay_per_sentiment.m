...
function [C_XY, C_YX, chi2_XY, chi2_YX, hyperparameters] ...
                 = ...
         Lois65_GPC_fin_n_NLP3_decay_per_sentiment(lag, pairs, if_returns, ...
...
load('Lois63_NLP_fin_data_sentiment3_decay_per_sentiment.mat');
...
name = [name_p1,'_',name_p2,'_',name_data,'_',name_cause, '_lag',num2str(lag),'_SENTIMENT3_dps']
